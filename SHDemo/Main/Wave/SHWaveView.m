...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        BEI6 = sc_screenSize.width/375;
        
        
        
        _firstWaveCircle = M_PI*2*FirstWaveNum/sc_screenSize.width;
        _firstCircleTime = (int)((M_PI*2/_firstWaveCircle)/(FirstWaveSpeed*BEI6));
        _firstWaveTime = 0;
        _firstVariable = 1;
        _firstIncrease = NO;
        
        _secondWaveCircle = M_PI*2*SecondWaveNum/sc_screenSize.width;
        _secondCircleTime = (int)((M_PI*2/_secondWaveCircle)/(SecondWaveSpeed*BEI6));
        _secondWaveTime = 2000;
        _secondVariable = 1;
        _secondIncrease = NO;
        
        _thirdWaveCircle = M_PI*2*ThirdWaveNum/sc_screenSize.width;
...
- (void)initContent
{
    ...
    _secondGradientLayer.frame = CGRectMake(0,  sc_screenSize.height-(SecondWaveCenterHeight*BEI6+SecondWaveAmplitude*BEI6), sc_screenSize.width, SecondWaveCenterHeight*BEI6+SecondWaveAmplitude*BEI6);
    ...
    _thirdGradientLayer.frame = CGRectMake(0,  sc_screenSize.height-(ThirdWaveCenterHeight*BEI6+ThirdWaveAmplitude*BEI6)-ThirdLineWidth*BEI6, sc_screenSize.width, ThirdWaveCenterHeight*BEI6+ThirdWaveAmplitude*BEI6+ThirdLineWidth*BEI6);
...
- (CGMutablePathRef)getThirdCurrentWavePath
{
    ...
    for (float x = 1.0f; x <=  sc_screenSize.width ; x++) {
        // 正弦波浪公式
